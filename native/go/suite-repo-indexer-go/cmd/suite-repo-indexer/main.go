...
func indexRepo(root string, cfg Config) RepoIndex {
	...
	idx.Examples = present(root, []string{"docs", "configs", "examples", "components/extensions/suite-dashboard-module/src/main/java", "components/extensions/suite-diagnostics-module/src/main/java"})
	_ = filepath.WalkDir(root, func(path string, d os.DirEntry, err error) error {
		if err != nil {
